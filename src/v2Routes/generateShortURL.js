                                ...
                                client
                                    ...
                                    .then((value) => {
                                        ...
                                        client
                                            ...
                                            .then((val) => {
                                                console.log("Inserted one url in url_visit_history_v2.");
                                                res.status(200).json({
                                            ...
                                            .catch((e) => {
                                                console.log("Error while inserting url in url_visit_history_v2.", JSON.stringify(e));
                                                res.status(500).json({ error: "Internal Error." });
                                                return;
                                            });
                                    })
                                    .catch((e) => {
                                        console.log("Error while inserting url in shorten_urls_v2.", JSON.stringify(e));
                                        res.status(500).json({ error: "Internal Error." });
                                    });
                                return;
                            }
